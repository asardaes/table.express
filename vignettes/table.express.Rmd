...
The [frame's main elements](https://github.com/Rdatatable/data.table/wiki) are the 3 shown:
`i`, `j`, and `by`.
...
it may be undesirable to do so when working with `data.table`s because it *always* lead to **deep** data copies.
