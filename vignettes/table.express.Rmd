...
By default, the verbs defined in this package automatically start a new chain whenever they want to define one of these elements,
...
However, thse two chains have different semantics:
...
This can be helpful in situations where automatic chaining can lead to a change in the expression's semantics:
